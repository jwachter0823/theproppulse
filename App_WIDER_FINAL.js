...
/* ── HERO ── */
.hero{position:relative;text-align:center;max-width:960px;margin:0 auto;padding:60px 0 44px}
...
.hero p{color:var(--t4);font-size:15.5px;line-height:1.6;max-width:640px;margin:0 auto 20px}
...
.hero-stat b{font-family:var(--mono);font-size:26px;font-weight:800;display:block}
...
.hero-step-t{font-size:14px;font-weight:600;color:var(--t2);line-height:1.3}
...
.hero-cta-primary{background:linear-gradient(135deg,#fbbf24,#f59e0b);color:#050810;font-family:var(--sans);font-size:16px;font-weight:700;padding:14px 36px;border:none;border-radius:9px;cursor:pointer;box-shadow:var(--glow-gold-sm),0 4px 16px rgba(0,0,0,0.3);transition:all .2s}
.hero-cta-primary:hover{box-shadow:var(--glow-gold);transform:translateY(-2px)}
.hero-cta-secondary{background:var(--emA2);border:1px solid var(--bdr3);color:var(--em);font-family:var(--sans);font-size:15px;font-weight:700;padding:14px 32px;border-radius:9px;cursor:pointer;transition:all .2s;text-shadow:0 0 6px rgba(6,182,212,0.2)}
...
.ctab{background:none;border:none;color:var(--t4);font-family:var(--sans);font-size:14.5px;font-weight:600;padding:11px 20px;cursor:pointer;transition:all .15s;position:relative;border-bottom:2px solid transparent;margin-bottom:-1px}
...
/* ── FIRM CARDS ── */
.cards{display:grid;grid-template-columns:repeat(auto-fill,minmax(min(400px,100%),1fr));gap:16px}
...
.fcard-desc{font-size:14px;color:var(--t4);line-height:1.55;margin-bottom:16px;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}
