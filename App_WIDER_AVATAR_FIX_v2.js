...
.nav-logo-text{font-size:18px;font-weight:700;letter-spacing:-.4px;color:var(--t1);text-shadow:0 0 12px rgba(6,182,212,0.15)}
...
/* ── HERO ── */
.hero{position:relative;text-align:center;max-width:1080px;margin:0 auto;padding:64px 0 48px}
...
.hero p{color:var(--t4);font-size:17px;line-height:1.6;max-width:740px;margin:0 auto 22px}
...
.hero-stat b{font-family:var(--mono);font-size:30px;font-weight:800;display:block}
...
.hero-cta-primary{background:linear-gradient(135deg,#fbbf24,#f59e0b);color:#050810;font-family:var(--sans);font-size:17px;font-weight:700;padding:15px 40px;border:none;border-radius:9px;cursor:pointer;box-shadow:var(--glow-gold-sm),0 4px 16px rgba(0,0,0,0.3);transition:all .2s}
.hero-cta-primary:hover{box-shadow:var(--glow-gold);transform:translateY(-2px)}
.hero-cta-secondary{background:var(--emA2);border:1px solid var(--bdr3);color:var(--em);font-family:var(--sans);font-size:16px;font-weight:700;padding:15px 36px;border-radius:9px;cursor:pointer;transition:all .2s;text-shadow:0 0 6px rgba(6,182,212,0.2)}
...
.sec-title{font-size:17px;font-weight:700;background:linear-gradient(135deg,var(--em2),var(--gold));-webkit-background-clip:text;-webkit-text-fill-color:transparent;filter:drop-shadow(0 0 6px rgba(251,191,36,0.15))}
...
/* ── FIRM CARDS ── */
.cards{display:grid;grid-template-columns:repeat(auto-fill,minmax(min(420px,100%),1fr));gap:18px}
...
.fcard-name{font-size:18px;font-weight:700;display:flex;align-items:center;gap:5px}
...
.fcard-desc{font-size:15px;color:var(--t4);line-height:1.55;margin-bottom:16px;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}
...
.nl-inner{max-width:700px;margin:0 auto;text-align:center;position:relative;z-index:1}
.nl-inner h3{font-size:32px;font-weight:800;margin-bottom:10px;letter-spacing:-.3px}
...
.fcard-pv{font-family:var(--mono);font-size:20px;font-weight:800;color:var(--gold);text-shadow:var(--glow-gold);animation:pulsGlow 3s ease-in-out infinite}
